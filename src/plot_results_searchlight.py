...
if __name__ in "__main__":
    ...
    for subject in ["0116"]:
        ...
        plot_glass_brain(searchlight_img, cmap='jet',colorbar=True, threshold=0.5,
                          ...
                          plot_abs=False)
        plt.savefig(fig_path / f"sub-{subject}_searchlight_unthresholded.png")

        plot_glass_brain(searchlight_img,cmap='prism',colorbar=True,threshold=0.60,title='pos vs neg (Acc>0.6')
        plt.savefig(fig_path / f"sub-{subject}_searchlight_thresholded.png")
        ...
        plt.savefig(fig_path / f"sub-{subject}_searchlight_statmap.png")
